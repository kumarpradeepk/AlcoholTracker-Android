 ...
 * generation time, so nothing here needs arc maths at runtime and both
 * platforms consume identical geometry.
 */
data class IconSpec(
    val name: String,
    ...
    fun toPath() = PathParser().let { p ->
        paths.forEach { p.parsePathString(it) }
        p.toPath()
    }
}
...
object AppIcons {
    ...
    val ChevronLeft = IconSpec(
        name = "ChevronLeft", strokeWidth = 2.2f, filled = false,
        paths = listOf(
            "M15 5L8 12L15 19"
        )
    )
    val ChevronRight = IconSpec(
        name = "ChevronRight", strokeWidth = 2.2f, filled = false,
        paths = listOf(
            "M9 5L16 12L9 19"
        )
    )
    val Lock = IconSpec(
        name = "Lock", strokeWidth = 2f, filled = false,
        paths = listOf(
    ...
    val Check = IconSpec(
        name = "Check", strokeWidth = 2.6f, filled = false,
        paths = listOf(
            "M5 12.5L9.5 17L19 7.5"
        )
    )
    val CheckBold = IconSpec(
        name = "CheckBold", strokeWidth = 2.8f, filled = false,
        paths = listOf(
            "M5 12.5L9.5 17L19 7.5"
        )
    )
    val Calendar = IconSpec(
        name = "Calendar", strokeWidth = 2f, filled = false,
        paths = listOf(
    ...
    val Droplet = IconSpec(
        name = "Droplet", strokeWidth = 1.8f, filled = false,
        paths = listOf(
    ...
    val DropletFill = IconSpec(
        name = "DropletFill", strokeWidth = 0f, filled = true,
        paths = listOf(
    ...
    val Export = IconSpec(
        name = "Export", strokeWidth = 2f, filled = false,
        paths = listOf(
            "M12 15L12 4",
            "M8 8L12 4L16 8",
    ...
    val Close = IconSpec(
        name = "Close", strokeWidth = 2.4f, filled = false,
        paths = listOf(
            "M6 6L18 18",
            "M18 6L6 18"
        )
    )
    val Highball = IconSpec(
        name = "Highball", strokeWidth = 1.8f, filled = false,
        paths = listOf(
    ...
    val Wine = IconSpec(
        name = "Wine", strokeWidth = 1.8f, filled = false,
        paths = listOf(
    ...
    val Pint = IconSpec(
        name = "Pint", strokeWidth = 1.8f, filled = false,
        paths = listOf(
            "M6.5 5L17.5 5L16.6 19L7.4 19L6.5 5Z",
            "M7.8 12.5L16.2 12.5"
        )
    )
    val Martini = IconSpec(
        name = "Martini", strokeWidth = 1.8f, filled = false,
        paths = listOf(
    ...
    val Person = IconSpec(
        name = "Person", strokeWidth = 2f, filled = false,
        paths = listOf(
    ...
    val Bottle = IconSpec(
        name = "Bottle", strokeWidth = 2f, filled = false,
        paths = listOf(
    ...
    val BarChart = IconSpec(
        name = "BarChart", strokeWidth = 2f, filled = false,
        paths = listOf(
            "M5 20L5 12",
            "M12 20L12 5",
            "M19 20L19 9"
    ...
    val Home = IconSpec(
        name = "Home", strokeWidth = 2.1f, filled = false,
        paths = listOf(
            "M4 11.2L12 4.6L20 11.2L20 20L4 20L4 11.2Z",
            "M9.5 20L9.5 14.5L14.5 14.5L14.5 20"
        )
    )
    val Sliders = IconSpec(
        name = "Sliders", strokeWidth = 2.1f, filled = false,
        paths = listOf(
            "M4 7.5L13 7.5",
            "M17.5 7.5L20 7.5",
            "M4 16.5L7 16.5",
    ...
    val Plus = IconSpec(
        name = "Plus", strokeWidth = 2.2f, filled = false,
        paths = listOf(
            "M12 5L12 19",
            "M5 12L19 12"
        )
    ...
    val Search = IconSpec(
        name = "Search", strokeWidth = 2.2f, filled = false,
        paths = listOf(
    ...
    val Trash = IconSpec(
        name = "Trash", strokeWidth = 2f, filled = false,
        paths = listOf(
            "M4 7L20 7",
    ...
    val All: List<IconSpec> = listOf(ChevronLeft, ChevronRight, Lock, Check, CheckBold, Calendar, Droplet, DropletFill, Export, Close, Highball, Wine, Pint, Martini, Person, Bottle, BarChart, Home, Sliders, Plus, Search, Trash)
}
