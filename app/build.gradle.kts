...
android {
    namespace = "com.mtss.alcoholtracker"
    compileSdk = 34
...
dependencies {
    ...
    // Purchases, entitlement and store-formatted prices. The paywall reads its
    // plans from a RevenueCat offering, so prices and trial lengths are changed
